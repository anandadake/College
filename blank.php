...
<head>
  ...
  <title>Blank | College Admin </title>
...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.php" class="logo">College <span class="lite">Admin</span></a>
      <!--logo end-->
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="#">
                    ...
                    <span class="message">I really like this admin panel.</span>
                </a>
              </li>
              <li>
                <a href="#">
                    ...
                    <span class="message">
                     Hi, What is next project plan?</span>
                 </a>
              </li>
              <li>
                <a href="#">
                    ...
                    <span class="message">I am like this .</span>
                 </a>
              </li>
              <li>
                <a href="#">
                    ...
                    <span class="message">Icon fonts are great.</span>
                 </a>
              </li>
              <li>
